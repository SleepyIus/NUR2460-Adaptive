...
export const SAVE_KEY = 'nur2460-study-weeks-2';
export const SAVE_SCHEMA = 'nur2460-study-weeks-save-2';
...
export class StudyStateError extends Error {
  constructor(code = 'INVALID_STUDY_SAVE') {
    super('This is not a valid Study backup for Exam 2 Complete 1.1.1. Your current progress was not replaced. Original, checkpoint, Study First, stage-1 Complete, and Hard 80 backups stay with their own versions.');
