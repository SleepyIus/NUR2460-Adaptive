...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>NUR2460 · Open the updated quiz</title><link rel="icon" href="../icons/favicon.svg"><style>body{font:1.125rem/1.6 system-ui,sans-serif;margin:4rem auto;padding:0 1.5rem;max-width:40rem;color:#203448;background:#f3f7f6}a{color:#09695f}a:focus-visible{outline:3px solid #203448;outline-offset:5px}</style></head><body><main><h1>The quiz has moved to the main page</h1><p>Both shared links now open the same updated quiz.</p><p><a id="continue" href="../">Open the updated quiz</a></p><p><a href="../earlier/study-checkpoint/">Open the earlier checkpoint and its saved progress</a></p><noscript><p>Use the link above to continue. The interactive quiz requires JavaScript.</p></noscript></main><script>const destination=new URL('../',location.href);destination.search=location.search;destination.hash=location.hash;document.getElementById('continue').href=destination.href;location.replace(destination.href);</script></body></html>
`;
const files=new Map([['index.html',Buffer.from(html)],['study-checkpoint/index.html',Buffer.from(redirect)],['earlier/index.html',read('dist/index.html')],['earlier/study-checkpoint/index.html',read('dist/study-checkpoint/index.html')],['earlier/study-checkpoint/release.json',read('dist/study-checkpoint/release.json')]]);
...
const publicRelease={...release,status:'released app; AI-assisted content review, independent educator review pending',candidateHtmlSha256:release.htmlSha256,htmlSha256:sha(Buffer.from(html)),canonicalEntry:'./',compatibilityEntry:'study-checkpoint/',earlierEntries:['earlier/','earlier/study-checkpoint/'],legacyMigration:false};
