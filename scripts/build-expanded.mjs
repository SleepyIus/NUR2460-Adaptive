...
const release={schema:'exam2-expanded-release-1',name:'Exam 2 Expanded 445',version:bank.version,status:'released app; AI-assisted content review, independent educator review pending',questions:445,tracks:Object.keys(bank.tracks).length,bankSha256:sha(read('bank.json')),htmlSha256:sha(html),hard80Questions:80,hard80Quotas:{Pregnancy:15,Labor:15,Newborn:15,GYN:15,Growth:10,Skin:5,GI:5},weekCounts:{All:445,4:79,5:145,6:145,7:76},weekMappingSha256:sha(read('week-mapping.json')),saveIsolation:{studyKey:'nur2460-exam2-coverage-private-3-study',hard80Key:'nur2460-exam2-coverage-private-3-hard80',legacyMigration:false},entrypoint:'study-checkpoint/',mainEntry:'../',earlierEntries:['../earlier/','../earlier/study-checkpoint/'],assets};
