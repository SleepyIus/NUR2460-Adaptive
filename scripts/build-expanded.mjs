...
const bank=JSON.parse(read('bank.json')),weekMapping=JSON.parse(read('week-mapping.json')),blueprintScope=JSON.parse(read('blueprint-scope.json'));
...
assert.equal(sha(read('blueprint-scope.json')),'7af79abae70f76bf054f872cf80f7589f844264c7b913e67a8b287d97c2e6ab6');
...
release.studyScopes={default:'full',full:445,blueprint:414,blueprintGyn:52,broaderGyn:31,mappingVersion:blueprintScope.version,mappingSha256:sha(read('blueprint-scope.json')),hard80Unaffected:true};
