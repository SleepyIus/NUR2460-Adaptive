...
function render() {
  ...
  root.innerHTML=`<a class="skip" href="#main">Skip to learning content</a><header class="site-header"><a class="brand" href="./" aria-label="NUR2460 Exam 2 Expanded 445"><img src="icons/favicon.svg" width="38" height="38" alt=""><span>NUR2460 <small>Exam 2 · Expanded</small></span></a></header>
    ...
    <p class="classic-link"><a href="earlier/" target="_blank" rel="noopener">Original quiz (classic layout) ↗</a><span>Opens in a new tab · separate saved progress</span></p>
    <p class="classic-link"><a href="lecture-focused/" target="_blank" rel="noopener">Lecture-focused study preview (242 questions) ↗</a><span>Separate lecture-focused route · separate saved progress</span></p>
