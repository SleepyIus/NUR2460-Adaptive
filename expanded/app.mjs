...
function render() {
  ...
  root.innerHTML=`<a class="skip" href="#main">Skip to learning content</a><header class="site-header"><a class="brand" href="./" aria-label="NUR2460 Exam 2 Expanded 445"><img src="icons/favicon.svg" width="38" height="38" alt=""><span>NUR2460 <small>Exam 2 · Expanded</small></span></a><details class="legacy-links"><summary>Other versions</summary><a href="../">Main quiz · 349 questions ↗</a><a href="../earlier/">Original quiz ↗</a><a href="../earlier/study-checkpoint/">Earlier checkpoint ↗</a></details></header>
