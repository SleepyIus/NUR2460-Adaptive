...
export const HARD80_SAVE_KEY = 'nur2460-exam2-coverage-private-3-hard80';
export const HARD80_SAVE_SCHEMA = 'nur2460-exam2-coverage-private-hard80-save-3';

const hard80Fail = () => {
  throw Error('This is not a valid Hard 80 backup for Exam 2 Expanded 445. Current progress was not replaced, and earlier-version data was not read or changed.');
};
